...
本文将 HRGNN 与涵盖传统 GNN、双曲方法和路网专用架构的全面基线方法集合进行对比，以确保严格的性能评估。图神经网络从 Scarselli 等\cite{scarselli2009gnn} 的开创性工作发展至 Gilmer 等\cite{gilmer2017mpnn} 的消息传递统一框架，已形成丰富的架构体系，可参阅\cite{ma2022gnn_survey_cn,xu2020gcn_survey_cn}对其系统性综述。
...
\setlength{\tabcolsep}{2pt}
\renewcommand{\arraystretch}{1.2}
\begin{longtable}{|>{\centering\arraybackslash}m{1.45cm}|>{\centering\arraybackslash}m{2.6cm}|>{\centering\arraybackslash}m{2.6cm}|>{\centering\arraybackslash}m{2.6cm}|>{\centering\arraybackslash}m{2.6cm}|>{\centering\arraybackslash}m{2.6cm}|}
\caption{各模型在测试城市样本道路上的预测结果。}
\label{tab:model_comparison} \\
\hline
\multirow{2}{*}{\textbf{模型}}
  & \multicolumn{3}{c|}{\textbf{城市内分类}}
  & \multicolumn{2}{c|}{\textbf{跨城市分类}} \\
\cline{2-6}
  & \textbf{\shortstack{威尼斯\\样本}}
  & \textbf{\shortstack{慕尼黑\\样本}}
  & \textbf{\shortstack{雅典\\样本}}
  & \textbf{\shortstack{罗马\\样本}}
  & \textbf{\shortstack{热那亚\\样本}} \\
\hline
\endfirsthead

\multicolumn{6}{c}{\bfseries \tablename\ \thetable{}（续）} \\
\hline
\multirow{2}{*}{\textbf{模型}}
  & \multicolumn{3}{c|}{\textbf{城市内分类}}
  & \multicolumn{2}{c|}{\textbf{跨城市分类}} \\
...
\hline
\multicolumn{6}{|l|}{%
  \textcolor{green}{\rule{0.4cm}{0.12cm}}~训练集\enspace
  \textcolor{blue}{\rule{0.4cm}{0.12cm}}~验证集\enspace
  \textcolor{yellow}{\rule{0.4cm}{0.12cm}}~预测正确\enspace
  \textcolor{red}{\rule{0.4cm}{0.12cm}}~预测错误} \\
\endlastfoot

\textbf{真实值} &
\includegraphics[width=\linewidth]{figures/model/1.png} &
\includegraphics[width=\linewidth]{figures/model/2.png} &
\includegraphics[width=\linewidth]{figures/model/3.png} &
\includegraphics[width=\linewidth]{figures/model/4.png} &
\includegraphics[width=\linewidth]{figures/model/5.png} \\
\hline

\textbf{GCN} &
\includegraphics[width=\linewidth]{figures/model/GCN1.png} &
\includegraphics[width=\linewidth]{figures/model/GCN2.png} &
\includegraphics[width=\linewidth]{figures/model/GCN3.png} &
\includegraphics[width=\linewidth]{figures/model/GCN4.png} &
\includegraphics[width=\linewidth]{figures/model/GCN5.png} \\
\hline

\textbf{GraphSAGE} &
\includegraphics[width=\linewidth]{figures/model/GraphSAGE1.png} &
\includegraphics[width=\linewidth]{figures/model/GraphSAGE2.png} &
\includegraphics[width=\linewidth]{figures/model/GraphSAGE3.png} &
\includegraphics[width=\linewidth]{figures/model/GraphSAGE4.png} &
\includegraphics[width=\linewidth]{figures/model/GraphSAGE5.png} \\
\hline

\textbf{HGCN} &
\includegraphics[width=\linewidth]{figures/model/HGCN1.png} &
\includegraphics[width=\linewidth]{figures/model/HGCN2.png} &
\includegraphics[width=\linewidth]{figures/model/HGCN3.png} &
\includegraphics[width=\linewidth]{figures/model/HGCN4.png} &
\includegraphics[width=\linewidth]{figures/model/HGCN5.png} \\
\hline

\textbf{RFN} &
\includegraphics[width=\linewidth]{figures/model/RFN1.png} &
\includegraphics[width=\linewidth]{figures/model/RFN2.png} &
\includegraphics[width=\linewidth]{figures/model/RFN3.png} &
\includegraphics[width=\linewidth]{figures/model/RFN4.png} &
\includegraphics[width=\linewidth]{figures/model/RFN5.png} \\
\hline

\textbf{GAIN} &
\includegraphics[width=\linewidth]{figures/model/GAIN1.png} &
\includegraphics[width=\linewidth]{figures/model/GAIN2.png} &
\includegraphics[width=\linewidth]{figures/model/GAIN3.png} &
\includegraphics[width=\linewidth]{figures/model/GAIN4.png} &
\includegraphics[width=\linewidth]{figures/model/GAIN5.png} \\
\hline

\textbf{HRNR} &
\includegraphics[width=\linewidth]{figures/model/HRNR1.png} &
\includegraphics[width=\linewidth]{figures/model/HRNR2.png} &
\includegraphics[width=\linewidth]{figures/model/HRNR3.png} &
\includegraphics[width=\linewidth]{figures/model/HRNR4.png} &
\includegraphics[width=\linewidth]{figures/model/HRNR5.png} \\
\hline

\textbf{HyperRoad} &
\includegraphics[width=\linewidth]{figures/model/HyperRoad1.png} &
\includegraphics[width=\linewidth]{figures/model/HyperRoad2.png} &
\includegraphics[width=\linewidth]{figures/model/HyperRoad3.png} &
\includegraphics[width=\linewidth]{figures/model/HyperRoad4.png} &
\includegraphics[width=\linewidth]{figures/model/HyperRoad5.png} \\
\hline

\textbf{HRGNN} &
\includegraphics[width=\linewidth]{figures/model/HRGNN1.png} &
\includegraphics[width=\linewidth]{figures/model/HRGNN2.png} &
\includegraphics[width=\linewidth]{figures/model/HRGNN3.png} &
\includegraphics[width=\linewidth]{figures/model/HRGNN4.png} &
\includegraphics[width=\linewidth]{figures/model/HRGNN5.png} \\
\hline
